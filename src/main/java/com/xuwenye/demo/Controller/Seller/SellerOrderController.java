 ...
 * 2.卖家可修改订单状态（发货、完成）
 * 3.卖家可查看店铺信息与更新
 * 4.登录态与卖家角色校验由 @UserCheck 切面完成，另做商品归属双重保护
 * <p>
 * @author ZuiM
 */
@RestController
...
public class SellerOrderController {
    ...
    public Result<?> getShopInfo(User currentUser) {
        ...
        // 判断是否为VIP卖家
        boolean isVip = currentUser.getUserRole() != null
                && currentUser.getUserRole().contains("VIP_SELLER");
